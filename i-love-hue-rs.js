...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "i-love-hue-rs.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "i-love-hue-rs.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'i_love_hue_rs'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'i_love_hue_rs':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_8763ae6a0527ff6dc740fec226484bf11ecfada1": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);localStorage.setItem(($0),($1))
            },
            ...
            "__cargo_web_snippet_92824c6a97a4296d0ca6e42162ef6cb6390e7094": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return localStorage.getItem(($1));})());
            },
            ...
            "__cargo_web_snippet_a1cf3921f9f66dd2342fcd57fc2d3d8dc8ffb8b1": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;})());
            },
            ...
            "__cargo_web_snippet_c785b93bd4bd84c21be13845ef710795334695d4": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight;})());
            },
